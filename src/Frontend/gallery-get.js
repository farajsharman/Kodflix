  ...
  return [
    {
      ...
      name: "BlackMirror",
      cover: BlackMirror,
      details: `An anthology series exploring a twisted, high-tech world where 
...

    {
      ...
      name: "BreakingBad",
      cover: BreakingBad,
      details: `A high school chemistry teacher diagnosed with inoperable 
...

    {
      ...
      name: "Deathnote",
      cover: Deathnote,
      details: `An intelligent high school student goes on a secret crusade 
...

    {
      ...
      name: "Fearthewalkingdead",
      cover: Fearthewalkingdead,
      details: `A Walking Dead spin-off, set in Los Angeles, following two 
...

    {
      ...
      name: "GOT",
      cover: GOT,
      details: `Nine noble families fight for control over the mythical 
...

    {
      ...
      name: "Thewire",
      cover: thewire,
      details: `Baltimore drug scene, seen through the eyes of 
